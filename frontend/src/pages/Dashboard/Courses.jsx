...
const Courses = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post("http://localhost:5000/courses/add", dataToSend);
      ...
      alert("❌ Diçka shkoi keq! Kontrolloni nëse profesori ose semestri ekzistojnë.");
    }
  };
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="group">
              ...
              <input 
                ...
                onChange={(e) => setCourseData({...courseData, emertimi: e.target.value})}
              />
            </div>
            ...
            <div>
              ...
              <textarea 
                ...
                onChange={(e) => setCourseData({...courseData, pershkrimi: e.target.value})}
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input 
                  ...
                  onChange={(e) => setCourseData({...courseData, kredite: e.target.value})}
                />
              </div>
              <div>
                ...
                <input 
                  ...
                  onChange={(e) => setCourseData({...courseData, kapaciteti: e.target.value})}
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-2">ID e Profesorit</label>
                <input 
                  type="number" 
                  required
                  placeholder="ID në databazë"
                  className="w-full p-4 bg-gray-50 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-indigo-500 focus:bg-white outline-none transition-all"
                  value={courseData.professor_id}
                  onChange={(e) => setCourseData({...courseData, professor_id: e.target.value})}
                />
              </div>
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-2">ID e Semestrit</label>
                <input 
                  type="number" 
                  required
                  placeholder="ID në databazë"
                  ...
                  onChange={(e) => setCourseData({...courseData, semester_id: e.target.value})}
                />
              </div>
            </div>
            ...
            <button 
              type="submit" 
              className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-black py-4 rounded-2xl shadow-lg shadow-indigo-100 transition-all transform active:scale-95 uppercase tracking-widest mt-4"
            >
